  ...
  return(
    <footer className={`${
        ...
        <div className="m-auto">
            <a className="transition-opacity duration-1000 delay-1000 opacity-0 opacity-100" href="https://github.com/retro1967" target="_blank" rel="noreferrer noopener"><FontAwesomeIcon icon={faGithub} width="16" size="2x" className="transform hover:scale-110 m-5"/></a>
